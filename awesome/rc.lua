...
beautiful.init("/home/urkh/.config/awesome/themes/dust/theme.lua")
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "rand", "dev", "web", "py", "jdk"}, s, layouts[1])
end
-- }}}
...
for s = 1, screen.count() do
    ...
    mywibox[s].widgets = {
        ...
        mylayoutbox[s],
        mytextclock,
    --    baticon, space, battbar, separator,
...
globalkeys = awful.util.table.join(
   ...
   --     function ()
   --         awful.util.spawn("gksu shutdown -h now " ..
   --                          "'Apagando el equipo...'")
   --     end),
